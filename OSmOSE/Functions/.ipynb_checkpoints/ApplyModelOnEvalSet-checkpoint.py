...
from HomeMadeModel_Functions import transform_simple
...
def ApplyModelOnEvalSet_main(dataset_ID, Task_ID, BM_Name, LengthFile, Fs, Version_name, Dyn, LabelsList, SplitName):
    ...
    if ModelName == 'Simple_CNN3':
        dataset = ClassDataset(raw_data_path,CSV_annotations_path,Dyn = Dyn, transform=transform_simple)
